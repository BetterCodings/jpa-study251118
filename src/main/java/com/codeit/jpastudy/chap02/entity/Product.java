...
public class Product {
    ...
    @Id // PK
    // UUID : 자동으로 UUID 생성
    // SEQUENCE : MYSQL에서 많이 사용
    // IDENTITY : 숫자 자동 증가 전략 사용
    ...
    @Enumerated(EnumType.STRING) // ORDINAL(문자열의 순서 번호를 저장), STRING(문자열 그대로 저장)
    ...
    @Transient // 데이터베이스에는 저장 안하고 클래스 내부에서만 사용할 필드
